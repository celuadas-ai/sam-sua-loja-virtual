export const translations = {
  pt: {
    ...
    auth: {
      ...
      demoHint: 'Demo: use "admin" para admin, "operador" para operador',
      fullName: 'Nome completo',
      yourName: 'O seu nome',
      emailOrPhone: 'Email ou Telefone',
      emailPlaceholder: 'exemplo@email.com ou 84XXXXXXX',
  ...
  en: {
    ...
    auth: {
      ...
      demoHint: 'Demo: use "admin" for admin, "operador" for operator',
      fullName: 'Full name',
      yourName: 'Your name',
      emailOrPhone: 'Email or Phone',
      emailPlaceholder: 'example@email.com or 84XXXXXXX',
      password: 'Password',
