          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <Input type="number" step="any" value={form.latitude} onChange={e => setForm(f => ({ ...f, latitude: e.target.value }))} placeholder="-25.9692" />
              </div>
              <div>
                <Label>Longitude *</Label>
                <Input type="number" step="any" value={form.longitude} onChange={e => setForm(f => ({ ...f, longitude: e.target.value }))} placeholder="32.5732" />
              </div>
            </div>
            <div>
              <Label>Raio máximo de entrega (km)</Label>
              <Input type="number" step="0.5" value={form.max_delivery_radius_km} onChange={e => setForm(f => ({ ...f, max_delivery_radius_km: e.target.value }))} placeholder="15" />
